...
class CloudChannelReportsServiceClient(metaclass=CloudChannelReportsServiceClientMeta):
    ...
    def report_path(
        ...
        return "accounts/{account}/reports/{report}".format(
            account=account,
            report=report,
        )
    ...
    def report_job_path(
        ...
        return "accounts/{account}/reportJobs/{report_job}".format(
            account=account,
    ...
    def parse_report_job_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^accounts/(?P<account>.+?)/reportJobs/(?P<report_job>.+?)$", path
        )
        return m.groupdict() if m else {}
