...
class CloudChannelServiceClient(metaclass=CloudChannelServiceClientMeta):
    ...
    def channel_partner_link_path(account: str,channel_partner_link: str,) -> str:
        ...
        return "accounts/{account}/channelPartnerLinks/{channel_partner_link}".format(account=account, channel_partner_link=channel_partner_link, )
    ...
    @staticmethod
    def channel_partner_repricing_config_path(account: str,channel_partner: str,channel_partner_repricing_config: str,) -> str:
        """Returns a fully-qualified channel_partner_repricing_config string."""
        return "accounts/{account}/channelPartnerLinks/{channel_partner}/channelPartnerRepricingConfigs/{channel_partner_repricing_config}".format(account=account, channel_partner=channel_partner, channel_partner_repricing_config=channel_partner_repricing_config, )
    ...
    def parse_channel_partner_repricing_config_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^accounts/(?P<account>.+?)/channelPartnerLinks/(?P<channel_partner>.+?)/channelPartnerRepricingConfigs/(?P<channel_partner_repricing_config>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def customer_repricing_config_path(account: str,customer: str,customer_repricing_config: str,) -> str:
        """Returns a fully-qualified customer_repricing_config string."""
        return "accounts/{account}/customers/{customer}/customerRepricingConfigs/{customer_repricing_config}".format(account=account, customer=customer, customer_repricing_config=customer_repricing_config, )
    ...
    def get_customer_repricing_config(self,
    ...
    def list_customer_repricing_configs(self,
    ...
    def create_customer_repricing_config(self,
    ...
    def update_customer_repricing_config(self,
    ...
    def delete_customer_repricing_config(self,
    ...
    def get_channel_partner_repricing_config(self,
    ...
    def list_channel_partner_repricing_configs(self,
    ...
    def create_channel_partner_repricing_config(self,
    ...
    def update_channel_partner_repricing_config(self,
    ...
    def delete_channel_partner_repricing_config(self,
