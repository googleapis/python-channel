...
class EduData(proto.Message):
    ...
    institute_type = proto.Field(proto.ENUM, number=1,
        enum=InstituteType,
    )

    institute_size = proto.Field(proto.ENUM, number=2,
        enum=InstituteSize,
    )
...
class CloudIdentityInfo(proto.Message):
    ...
    customer_type = proto.Field(proto.ENUM, number=1,
        enum=CustomerType,
    )
    ...
    edu_data = proto.Field(proto.MESSAGE, number=22,
        message='EduData',
    )
...
class Value(proto.Message):
    ...
    proto_value = proto.Field(proto.MESSAGE, number=4, oneof='kind',
        message=gp_any.Any,
    )
